...
RM=/bin/rm -f
VERSION=R$(shell date +%Y%m%d)

JRAGFILES=ast/ClassRelations.jrag ast/ComponentsUtil.jrag ast/Errorcheck.jrag \
	ast/JaddCodeGen.jrag ast/NameBinding.jrag ast/FileNameEscape.jrag \
	jrag/Attributes.jrag jrag/Circular.jrag jrag/CollectionAttributes.jrag \
	jrag/Errorcheck.jrag jrag/JragCodeGen.jrag jrag/NameBinding.jrag
...
jar : all
	jar -cmf manifest jastadd2.jar LICENSE JastAdd.properties ast/*.class ast/AST/*.class jastadd/*.class jrag/*.class jrag/AST/*.class org/aspectj/lang/*.class org/aspectj/runtime/*.class org/aspectj/runtime/internal/*.class org/aspectj/runtime/reflect/*.class

#source-jar: all
#	jar -cmf manifest jastadd2-src.jar LICENSE JastAdd.properties manifest ast/*.ast ast/*.jjt ast/*.jrag ast/*.java jrag/*.jrag jrag/*.java jrag/*.jjt jrag/AST/SimpleNode.java jastadd/*.java jastadd/*.jrag Makefile org/aspectj/lang/*.class org/aspectj/runtime/*.class org/aspectj/runtime/internal/*.class org/aspectj/runtime/reflect/*.class tools/*.jar jrag/AST/Token.java doc/reference-manual.html doc/release-notes.html
#	mkdir jastadd2-src
...
source-zip: all
	jar -cmf manifest jastadd2-src-temp.jar LICENSE JastAdd.properties manifest ast/*.ast ast/*.jjt ast/*.jrag ast/*.java jrag/*.jrag jrag/*.java jrag/*.jjt jrag/AST/SimpleNode.java jastadd/*.java jastadd/*.jrag Makefile org/aspectj/lang/*.class org/aspectj/runtime/*.class org/aspectj/runtime/internal/*.class org/aspectj/runtime/reflect/*.class tools/*.jar jrag/AST/Token.java doc/reference-manual.html doc/release-notes.html
	mkdir jastadd2-src
...
clean :
	...
	$(RM) jrag/AST/AST*
	$(RM) jrag/AST/Jrag.jj
	$(RM) jrag/AST/TokenMgrError.java
	$(RM) jrag/AST/JragParser*
	$(RM) jrag/AST/JJT*
	$(RM) jrag/AST/Node.*
	$(RM) jrag/AST/JavaCharStream*
	$(RM) jrag/AST/ParseException*
